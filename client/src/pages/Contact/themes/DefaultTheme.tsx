...
import { ExternalLink, MessageSquare, Sparkles, Send, FileText } from "lucide-react";
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <motion.div
        ...
        className="relative z-20 w-[95%] max-w-[1100px] mx-auto transform-gpu"
      >
        <div 
          className="relative overflow-hidden backdrop-blur-2xl bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-8 md:p-16 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.7)] flex flex-col lg:flex-row gap-12 lg:gap-20 items-center group transform-gpu"
        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left space-y-8" style={{ transform: "translateZ(80px)", willChange: 'transform' }}>
            <div className="relative inline-block">
              <div className="relative w-28 h-28 md:w-36 md:h-36 rounded-2xl overflow-hidden p-[2px] bg-gradient-to-tr from-blue-500 via-indigo-500 to-purple-500 transform-gpu">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10 text-xs text-gray-300 transform-gpu">
          ...
          <div className="w-full lg:w-[400px] flex flex-col gap-2.5" style={{ transform: "translateZ(100px)", willChange: 'transform' }}>
      ...
      <div className="w-full mt-16 sm:mt-32 relative z-10 overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden flex items-center py-6 sm:py-10 bg-white/[0.01] border-y border-white/[0.05] transform-gpu">
          ...
          <div className="marquee-inner">
            {[...techSkills, ...techSkills].map((Icon, idx) => (
              <div key={idx} className="group flex flex-col items-center gap-3 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all duration-500 transform-gpu" style={{ willChange: 'transform, opacity' }}>
                <Icon className="w-10 h-10 md:w-14 md:h-14 transition-transform duration-500 group-hover:scale-125 transform-gpu" />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="w-full max-w-[1100px] mt-16 sm:mt-32 px-4 relative z-20">
        <motion.div
          ...
          className="text-center mb-8 sm:mb-12 transform-gpu"
        >
        ...
        <motion.div 
          ...
          className="relative w-full max-w-4xl mx-auto rounded-[2rem] overflow-hidden border border-white/10 bg-[#111111] shadow-2xl group transform-gpu"
          style={{ willChange: 'transform, opacity' }}
        >
          {/* Unified High-Fidelity Resume Card (Zero bugs, 100% consistent) */}
          <div className="relative w-full overflow-hidden bg-[#111111] touch-none pointer-events-none select-none transform-gpu">
            <img 
              src={displayImage} 
              alt="Azizbek Resume" 
          ...
          <div className="absolute bottom-5 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-40 w-[85%] sm:w-auto">
            {/* File Info Badge */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-white/70 text-[10px] sm:text-xs transform-gpu">
              <FileText size={14} />
              <span>Azizbek_Mirzavaliyev.pdf</span>
            </div>

            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 p-2 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-xl shadow-2xl w-full sm:w-auto transform-gpu">
            <a href="/Azizbek_Mirzavaliyev.pdf" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-white/10 hover:bg-white/20 text-white rounded-xl font-medium transition-all flex items-center justify-center gap-2 text-sm sm:text-base pointer-events-auto transform-gpu">
              <ExternalLink size={18} /> To'liq ko'rish
            </a>
            <a href="/Azizbek_Mirzavaliyev.pdf" download="Azizbek_Mirzavaliyev_Resume.pdf" className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 text-sm sm:text-base pointer-events-auto transform-gpu">
